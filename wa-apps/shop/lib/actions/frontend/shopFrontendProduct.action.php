...
{
    /**
     * @var shopProductReviewsModel sku duble
     */
    ...
    public function execute()
    {
		...
		{$kolds='0'.$kolds;}
		 ...
		 <img  style="width:50px" src="/wa-data/public/shop/products/'.$koldz.'/'.$kolds.'/'.$dubles_img['product_id'].'/images/'.$dubles_img['id'].'/'.$dubles_img['image_id'].'.96x96.jpg"/></a>';
